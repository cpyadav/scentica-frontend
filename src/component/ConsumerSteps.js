...
export default (props) => {
    return (
        ...
        >
            ...
            <Tags count={CONSUMER_STEPS.length} {...props} pField='tg_user_occup' title="Occupation" label="Select Consumer Occupation" placeholder='Select Consumer Occupation' fields={OCCUPATION} />
        </Steps>
    )
}
